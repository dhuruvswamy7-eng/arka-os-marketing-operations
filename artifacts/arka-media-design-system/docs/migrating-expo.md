# Migrating Expo UI to Arka Media Design System

Read `artifacts/arka-media-design-system/docs/AGENTS.md` and
`artifacts/arka-media-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/arka-media-design-system/lib/native-theme` and
  `@workspace/arka-media-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/arka-media-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/arka-media-design-system` and retains only
