# Consuming Arka Media Design System in Expo apps

Read `artifacts/arka-media-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/arka-media-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/arka-media-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/arka-media-design-system/lib/native-theme";
import { useColors } from "@workspace/arka-media-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/arka-media-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/arka-media-design-system/components/native/badge";
import { Button } from "@workspace/arka-media-design-system/components/native/button";
import { Card } from "@workspace/arka-media-design-system/components/native/card";
```
...
Import and render
`@workspace/arka-media-design-system/components/native/button`, then run Expo
