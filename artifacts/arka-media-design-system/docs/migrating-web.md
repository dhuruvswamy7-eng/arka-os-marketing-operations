# Migrating web UI to Arka Media Design System

Read `artifacts/arka-media-design-system/docs/AGENTS.md` and
`artifacts/arka-media-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/arka-media-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/arka-media-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/arka-media-design-system/hooks/use-toast`
