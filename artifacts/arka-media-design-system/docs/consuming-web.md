# Consuming Arka Media Design System in web apps

Read `artifacts/arka-media-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/arka-media-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/arka-media-design-system/styles.css";
```
...
`node_modules/@workspace/arka-media-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/arka-media-design-system/components/ui/button";
import { cn } from "@workspace/arka-media-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/arka-media-design-system/hooks/use-toast";
```
...
`@workspace/arka-media-design-system/components/ui/button`. Run the app's typecheck
